...
<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="packageprice" id="packageprice" placeholder=" Package Price in PKR" value="<?php echo htmlentities($result->PackagePrice);?>" required>
									</div>
								</div>
